...
```javascript
ctors = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-typed-ctors@v0.3.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/array-typed-ctors/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/array-typed-ctors/actions/workflows/test.yml?query=branch:v0.3.1
